...
// This method is not working properly on swerve board because we have 2 motors, not one.
// The method WriteSenderSerialAndPacketID from CANPacket.c uses this function
